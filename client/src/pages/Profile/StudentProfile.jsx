    ...
    <>
      ...
      <div className="content rounded-3 mx-3 pb-2">
        ...
        <img
          ...
          className="profileImage rounded-circle border border-primary border-5"
        />
        <div className="d-flex m-3">
          <div className="shadow bottom col card mx-2 p-1 h-auto">
            ...
            <button
              type="submit"
              class=" mx-5 mb-2 mt-2 btn btn-primary btn-sm"
            >
              Edit Information
            </button>
          </div>
          ...
          <div className="shadow bottom schools col card mx-2 p-1">
            ...
            <button type="submit" class=" mx-5 mb-2 btn btn-primary btn-sm">
              Update Interests
            </button>
          </div>
